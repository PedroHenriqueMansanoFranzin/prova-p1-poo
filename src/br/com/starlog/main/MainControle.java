...
public class MainControle {
    public static void main(String[] args) {
        ...
        Carga c2 = new Carga("ORB-102-RJ", "PADRÃO", 8.0, 120.00);
        Carga c3 = new Carga("ORB-103-MG", "CRIOGENICA", 12.0, 300.00);
        Carga c4 = new Carga("ORB-104-PR", "BIOLÓGICA", 15.0, 300.00);
        System.out.println("Carga[rastreio = , " + codigoRastreio + "categoria = , " + categoria + "peso = , " + pesoKg + "seguro = ]" + valorSeguro);
